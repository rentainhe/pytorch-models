...
def spresnet18(num_classes=1000):
...
def spresnet34(num_classes=1000):
...
def spresnet50(num_classes=1000):
...
def spresnet101(num_classes=1000):
...
def spresnet152(num_classes=1000):
